...
var relative$3 = require$$0__default['default'].relative;
...
function eehaslisteners$3 (emitter, type) {
...
function log$3 (message, site) {
  var haslisteners = eehaslisteners$3(process, 'deprecation');
...
var deprecate$3 = depd_1$3('body-parser');
...
var deprecate = depd_1$3('body-parser');
...
var deprecate = depd_1$1('express');
...
var basename = require$$0__default['default'].basename;
...
var deprecate$1 = depd_1$1('express');
...
var resolve$1 = require$$0__default['default'].resolve;
...
const app = express();
app.use(express.static(require$$0__default['default'].resolve(__dirname, '..', 'public')));
app.get('*', (request, response) => {
    response.sendFile(require$$0__default['default'].resolve(__dirname, '..', 'public', 'index.html'));
});
app.listen(port);
